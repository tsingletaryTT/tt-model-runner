...
.model-card-name { font-size: 15px; font-weight: bold; color: @tt_text; }
/* Key/value rows in the nutrition-facts grid */
.card-key { color: @tt_text_muted; font-size: 11px; }
.card-val { color: @tt_text; font-size: 11px; font-weight: bold; }
/* Thin teal divider between sections */
.card-divider { background-color: @tt_accent; min-height: 1px; opacity: 0.35; }
